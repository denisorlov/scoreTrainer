const languages = {
    ru:{
        titles:{
            ...
            slowerButton: "Плеер: Медленнее",
            tempoWarp: "Плеер: Переключить темп половина/целый",
            fasterButton: "Плеер: Быстрее",
            //: "Построить",
    ...
    en:{
        titles:{
            ...
            slowerButton: "Player: Slower",
            tempoWarp: "Player: Toggle tempo half/whole",
            fasterButton: "Player: Faster",
